...
app.config['SQLALCHEMY_DATABASE_URI']='postgres://nmfgqehlsypuhl:c307854f628d77f24bd53865938612756f0a7d77d9e8e1bf6a710568f7af7506@ec2-107-22-122-106.compute-1.amazonaws.com:5432/dakbq9nr5e6a7d'
db=SQLAlchemy(app)
...
def hospitalUser():
    ...
    if('user' in session and session['user']==params['user']):
        ...
        if request.method=="POST":
            ...
            mail.send_message('BED CENTER',sender=params['gmail-user'],recipients=[email],body=f"Welcome thanks for choosing us\nYour Login Credentials Are:\n Email Address: {email}\nPassword: {password}\n\nHospital Code {hcode}\n\n Do not share your password\n\n\nThank You..." )
